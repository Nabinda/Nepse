    ...
    return Container(
      ...
      child: GridView.builder(
          ...
          itemBuilder: (context, index) {
            return informationItem(_yourInformation[index].text,
                _yourInformation[index].icon, _yourInformation[index].route);
          }),
    );
  }
  ...
  Widget _updatesInformationWidget(BuildContext context) {
    ...
    return Container(
      ...
      child: GridView.builder(
          ...
          itemBuilder: (context, index) {
            return informationItem(_updates[index].text, _updates[index].icon,
                _updates[index].route);
          }),
    );
  }
}
